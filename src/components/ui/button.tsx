  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-heading",
  {
    variants: {
      variant: {
        ...
        hero: "bg-accent text-accent-foreground hover:bg-accent/90 shadow-lg hover:shadow-xl hover:-translate-y-1 animate-pulse-glow font-bold tracking-wide",
        military: "bg-military text-military-foreground hover:bg-military/90 shadow-md hover:shadow-lg",
        gold: "bg-gradient-to-r from-accent to-secondary text-dark font-bold shadow-lg hover:shadow-xl hover:-translate-y-0.5",
      },
      size: {
